...
rf_inputResoluton = 112                 # DNN image input width and height in pixels. ALso try e.g. 4*224=896 pixels.
rf_dropoutRate    = 0.5                 # Droputout rate
rf_mbSize         = 8                  # Minibatch size (reduce if running out of memory)
...
rootDir = os.path.expanduser('~') + "/Desktop/RoofData/"  \
